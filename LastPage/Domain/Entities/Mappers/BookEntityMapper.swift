...
class BookEntityMapper {
    static func map(_ bookdetail: BookDetail) -> BookEntity {
        return BookEntity(id: nil, bookDetail: BookDetailEntity( imagePath: bookdetail.cover, addedDate: nil, title: bookdetail.title, author: bookdetail.author, status: .unread, shortMemo: TextResource.Global.empty.text, categories: bookdetail.categoryName, feelings: []), beforeMemo: nil, inProgressMemo: [], afterMemo: nil, keywords: [])
    }
